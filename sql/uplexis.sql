...
--
-- Host: localhost
-- Generation Time: 07-Abr-2016 às 22:07
...
ALTER TABLE `sintegra`
  ADD PRIMARY KEY (`id`),
  ADD KEY `sintegra_user_id_foreign` (`user_id`);
...
--
ALTER TABLE `sintegra`
  ADD CONSTRAINT `sintegra_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`);
